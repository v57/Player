...
final class EnhancementPresetTests: XCTestCase {
    ...
    private func makePreset(
        ...
        AudioEnhancementPreset(
            ...
            compressorHeadroomDB: compressorHeadroomDB,
            compressorAttack: compressorAttack,
            compressorRelease: compressorRelease,
            compressorMasterGainDB: compressorMasterGainDB,
            limiterEnabled: limiterEnabled,
            limiterPreGainDB: limiterPreGainDB,
    ...
    private var expectedOriginal: AudioEnhancementPreset {
        makePreset(
            ...
            compressorHeadroomDB: 12,
            compressorAttack: 0.015,
            compressorRelease: 0.250,
            compressorMasterGainDB: 0,
            limiterEnabled: false,
            limiterPreGainDB: 0,
            limiterAttack: 0.012,
            limiterRelease: 0.250,
            eqEnabled: false,
            eqFrequency: 2000,
            eqGainDB: 0,
            eqQ: 1.0
    ...
    private var expectedDialogue: AudioEnhancementPreset {
        makePreset(
            ...
            compressorHeadroomDB: 12,
            compressorAttack: 0.020,
            compressorRelease: 0.200,
            compressorMasterGainDB: 3,
            limiterEnabled: true,
            limiterPreGainDB: 1,
            limiterAttack: 0.012,
            limiterRelease: 0.250,
    ...
    func testRawValueRoundTripAndAllCases() {
        ...
        XCTAssertEqual(AudioEnhancementMode.allCases.map(\.rawValue), ["original", "balanced", "dialogue"])
    }
    ...
    func testHeadroomAboveCeilingForAllPresets() {
        for mode in AudioEnhancementMode.allCases {
            XCTAssertLessThanOrEqual(
                AudioEnhancementPreset.preset(for: mode).headroomAboveCeiling(),
                -1.0,
