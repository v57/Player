...
// on <stdint.h>/<stddef.h>. That makes it safe to drop into the app's Swift
// bridging header (mpv-bridge.h pattern) with zero build-setting changes,
// while the implementation (MediaDemuxer.c) links libavformat privately.
//
// Ownership rules:
