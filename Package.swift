...
let package = Package(
  name: "MediaPlayer", platforms: [.macOS(.v27)],
  products: [
  ...
  targets: [
    ...
    .target(
      name: "MediaPlayerCDemux", publicHeadersPath: ".",
    ...
    .target(
      name: "MediaPlayer", dependencies: ["MediaPlayerCDemux"],
      swiftSettings: [.enableUpcomingFeature("ApproachableConcurrency")], ),
    .testTarget(
      name: "MediaPlayerTests", dependencies: ["MediaPlayer"], path: "Tests/MediaPlayerTests",
      linkerSettings: [
